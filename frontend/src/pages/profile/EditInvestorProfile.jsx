    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <div style={styles.pageHeader}>
          ...
          <p style={styles.sub}>Update your firm details. Investment criteria are managed per-fund.</p>
        </div>
        ...
        <form onSubmit={handleSave}>
          ...
          <div style={styles.hint}>
            ...
            <span>Investment criteria (sectors, stages, ticket size, deal types) are managed individually on each fund. <Link to="/dashboard/investor" style={{ color: '#7c3aed', fontWeight: 500 }}>Go to Dashboard</Link> to edit your funds.</span>
          </div>
...
const styles = {
  ...
  hint: { display: 'flex', gap: '0.6rem', alignItems: 'flex-start', background: '#f5f3ff', borderRadius: 10, padding: '0.85rem 1rem', marginBottom: '1.25rem', fontSize: '0.82rem', color: '#5b21b6', lineHeight: 1.45 },
